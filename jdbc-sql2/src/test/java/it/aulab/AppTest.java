...
public class AppTest {
    ...
    static final String connection_string_mysql = "jdbc:mysql://localhost:3306/aulab?user=root&password=root";
    ...
    public static void main(String[] args) throws Exception {
            ...
            // "com.mysql.cj.jdbs"
            Connection connection = DriverManager.getConnection(connection_string_mysql);
